...
from .processor_functions import handle_horse_name, handle_horse_country, handle_horse_birthdate, handle_gender, handle_breed


class FrenchHorseInfo(HorseInfo):
